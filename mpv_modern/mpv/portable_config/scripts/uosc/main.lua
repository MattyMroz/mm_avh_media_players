...
-- Default content of the context menu
local function create_default_menu()
	return {
		{title = 'Wczytywanie', items = {
			{title = '※ Eksplorator Plików', value = 'script-binding uosc/open-file'},
			{title = '※ Importuj Ścieżkę Napisów', value = 'script-binding uosc/load-subtitles'},
		},},
		{title = 'Nawigacja', items = {
			{title = '※ Lista Odtwarzania', value = 'script-binding uosc/playlist'},
			{title = '※ Lista Wersji', value = 'script-binding uosc/editions'},
			{title = '※ Lista Rozdziałów', value = 'script-binding uosc/chapters'},
			{title = '※ Lista Ścieżek Wideo', value = 'script-binding uosc/video'},
			{title = '※ Lista ścieżek dźwiękowych', value = 'script-binding uosc/audio'},
			{title = '※ Lista ścieżek napisów', value = 'script-binding uosc/subtitles'},
			{title = 'Losowe Odtwarzanie Utworów Na Liście Odtwarzania', value = 'playlist-shuffle'},
		},},
		{title = '※ Zrzut ekranu', value = 'script-binding uosc/shot'},
		{title = 'Wideo', items = {
			{title = 'Zmień Tryb Dekodowania', value = 'cycle-values hwdec no auto auto-copy'},
			{title = 'Zmień Tryb Usuwania Pasów Kolorów', value = 'cycle deband'},
			{title = 'Zmień Tryb Usuwania Linii Międzyklatkowych', value = 'cycle deinterlace'},
			{title = 'Zmień Tryb Automatycznego Korygowania Kolorów', value = 'cycle icc-profile-auto'},
			{title = 'Zmień Tryb Analizy Czasowej', value = 'cycle correct-pts'},
		},},
		{title = 'Narzędzia', items = {
			{title = 'Włącz/Wyłącz Wyświetlanie Statystyki Dla Nerdów', value = 'script-binding stats/display-stats-toggle'},
			{title = 'Wyświetl Konsolę', value = 'script-binding console/enable'},
			{title = 'Zmień Obramowanie Okna', value = 'cycle border'},
			{title = 'Przełącz Okno Na Tryb Zawsze Na Wierzchu', value = 'cycle ontop'},
			{title = '※ Lista Urządzeń Wyjściowych Audio', value = 'script-binding uosc/audio-device'},
			{title = '※ Jakość Strumieniowania', value = 'script-binding uosc/stream-quality'},
			{title = '※ Otwórz Bieżący Folder Pliku', value = 'script-binding uosc/show-in-directory'},
			{title = '※ Otwórz Folder Ustawień', value = 'script-binding uosc/open-config-directory'},
		},},
		{title = 'Zatrzymaj', value = 'stop'},
		{title = 'Wyjdź', value = 'quit'},
	}
end
...
local track_loaders = {
	{name = 'subtitles', hint = 'Ścieżkę Napisów', prop = 'sub', allowed_types = config.subtitle_types},
	{name = 'audio', hint = 'Ścieżkę Dźwiękową', prop = 'audio', allowed_types = config.media_types},
	{name = 'video', hint = 'Ścieżkę Wideo', prop = 'video', allowed_types = config.media_types},
}
for _, loader in ipairs(track_loaders) do
	...
	bind_command(menu_type, function()
		...
		open_file_navigation_menu(
			...
			{type = menu_type, title = 'Importuj ' .. loader.hint, allowed_types = loader.allowed_types}
		)
	end)
end
bind_command('subtitles', create_select_tracklist_type_menu_opener(
	'Lista Ścieżek Napisów', 'sub', 'sid', 'script-binding uosc/load-subtitles'
))
bind_command('audio', create_select_tracklist_type_menu_opener(
	'Lista Ścieżek Dźwiękowych', 'audio', 'aid', 'script-binding uosc/load-audio'
))
bind_command('video', create_select_tracklist_type_menu_opener(
	'Lista Ścieżek Wideo', 'video', 'vid', 'script-binding uosc/load-video'
))
...
bind_command('stream-quality', function()
	...
	Menu:open({type = 'stream-quality', title = 'Jakość Strumieniowania', items = items}, function(format)
...
bind_command('audio-device', create_self_updating_menu_opener({
	title = 'Lista Urządzeń Wyjściowych Audio',
...
mp.register_script_message('thumbfast-info', function(json)
	...
	if type(data) ~= 'table' or not data.width or not data.height then
		...
		msg.error('thumbfast-info: otrzymany plik json nie wygenerował tabeli z informacjami o miniaturach')
	else
		thumbnail = data
		request_render()
	end
