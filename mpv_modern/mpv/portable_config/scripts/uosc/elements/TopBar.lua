...
function TopBar:init()
	...
	self.buttons = {
		...
		TopBarButton:new('tb_max', {icon = 'crop_square', background = '111111', command = decide_maximized_command}),
		TopBarButton:new('tb_min', {icon = 'minimize', background = '1111111', command = 'cycle window-minimized'}),
	}
end
